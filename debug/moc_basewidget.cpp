...
QT_MOC_LITERAL(3, 25, 16), // "myMath::Triangle"
QT_MOC_LITERAL(4, 42, 9), // "startTask"
QT_MOC_LITERAL(5, 52, 7) // "numTask"

    },
    "BaseWidget\0signalResult\0\0myMath::Triangle\0"
    "startTask\0numTask"
};
...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalResult((*reinterpret_cast< const myMath::Triangle(*)>(_a[1]))); break;
        case 1: _t->startTask((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaseWidget::*)(const myMath::Triangle & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseWidget::signalResult)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BaseWidget::signalResult(const myMath::Triangle & _t1)
{
